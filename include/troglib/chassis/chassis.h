...
#include "troglib/movements/movement.h"
#include "troglib/devices/trackingWheel.h"
#include "troglib/chassis/structs.h"
#include "troglib/chassis/odom.h"
...
class Chassis {
    ...
    public:
         ...
         */
        void follow(float path, float lookahead, int timeout, bool forwards = true, int maxSpeed = 127);
